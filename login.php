...
<html lang="pt">
  <head>
    ...
    <title>Gestão de Contas | Login</title>
      ...
      >
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            ...
            <form id="login_form" method="post" class="space-y-6" class="login_form" name="login_form">
              <input
                class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker"
                type="email"
                name="email"
                placeholder="Conta de email"
                autocomplete="off"
                required
              />
              <input
              ...
              <div class="flex items-center justify-between">
                ...
                <label class="flex items-center">
                  ...
                  <span class="ml-3 text-sm font-normal text-gray-500 dark:text-gray-400">Manter sessão</span>
                </label>
                <a href="index.php?p=2" class="text-sm text-blue-600 hover:underline">Recuperar password</a>
              </div>
			  <!-- alertas de login -->
			  <div class="alert error" id="alerta"> </div>
              <div>
                <button
                  type="submit"
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
              Não tem conta? <a href="index.php?p=1" class="text-blue-600 hover:underline">Registar</a>
            </div>
          </div>
        </main>
      </div>

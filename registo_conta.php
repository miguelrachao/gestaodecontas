...
<html lang="pt">
  <head>
    ...
    <title>Gestão de Contas | Novo Registo</title>
    ...
    <script src="build/js/background/registo_conta.js" defer></script>
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            <p>
                ...
                <h1 class="text-xl font-semibold text-center" style="margin-top: -30px;">Registo</h1>
            </p>
            <form id="registoconta_form" method="post" class="space-y-6" class="registoconta_form" name="registoconta_form">
            <input

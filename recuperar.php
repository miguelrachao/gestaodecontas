...
<html lang="pt">
  <head>
    ...
    <title>Gestão de Contas | Recuperar Password</title>
    ...
    <script src="build/js/background/recuperar_conta.js" defer></script>
      ...
      >
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            <p>
                <a href="index.php"><img src="build/images/voltar.png"></a>
                <h1 class="text-xl font-semibold text-center" style="margin-top: -30px;">Recuperar password</h1>
            </p>
            <form id="recuperar_form" method="post" class="space-y-6" class="recuperar_form" name="recuperar_form">
              <input

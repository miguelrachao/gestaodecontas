              ...
              <div x-data="{ isActive: true, open: <?php if(isset($_GET['p'])){ if(($_GET['p']=="1") || ($_GET['p']=="7")){ echo "true";}else{echo"false";} }else{echo"false";}?> }">
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                  <a
                    href="index.php?p=1"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700 <?php if($_GET['p']=="1"){ echo "dark:bg-primary dark:text-light bg-primary-100 text-gray-500";} ?>"
                  >
                    Novo Registo
                  </a>
                  <a
